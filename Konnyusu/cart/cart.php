...
$cartTotalItems = array_sum(array_column($cartItems, 'quantity'));
?>
<!DOCTYPE html>
<html lang="id">
<head>
  ...
  <div>
    <div class="summary-panel animate-fadeup" style="animation-delay:.1s">
      ...
      <div class="promo-input">
        <input type="text" placeholder="Kode promo / voucher">
        <button>Pakai</button>
      </div>
