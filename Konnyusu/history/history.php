...
$orders = [
    [
        'id'      => '#1094',
        'date'    => '15 Mei 2026, 10:23',
        'status'  => 'Selesai',
        'items'   => [
            ['name'=>'Caramel Tart Latte','qty'=>2,'price'=>32000,'image'=>'caramel-tart.jpeg'],
            ['name'=>'Caramel Tart',      'qty'=>1,'price'=>18000,'image'=>'caramel-tart.jpeg'],
        ],
        'total'   => 87000,
        'payment' => 'GoPay',
        'rating'  => 5,
    ...
    [
        'id'      => '#1089',
        'date'    => '12 Mei 2026, 15:47',
        'status'  => 'Selesai',
        'items'   => [
            ['name'=>'Matcha Oat Latte','qty'=>1,'price'=>28000,'image'=>'oat-latte.jpg'],
            ['name'=>'Signetone Oat Latte','qty'=>1,'price'=>30000,'image'=>'oat-latte.jpg'],
        ],
        'total'   => 63000,
        'payment' => 'QRIS',
        'rating'  => 4,
    ...
    [
        'id'      => '#1071',
        'date'    => '8 Mei 2026, 09:15',
        'status'  => 'Dibatalkan',
        'items'   => [
            ['name'=>'Signature Series','qty'=>1,'price'=>45000,'image'=>'signature.jpg'],
        ],
        'total'   => 50000,
    ...
    [
        'id'      => '#1058',
        'date'    => '3 Mei 2026, 18:30',
        'status'  => 'Selesai',
        'items'   => [
            ['name'=>'Sea Salt Cream Latte','qty'=>2,'price'=>28000,'image'=>'oat-latte.jpg'],
            ['name'=>'Savory Croissant',    'qty'=>2,'price'=>22000,'image'=>'savory.jpg'],
        ],
        'total'   => 105000,
        'payment' => 'OVO',
        'rating'  => 5,
...
<div class="history-wrap">
  ...
  <div class="hist-stats animate-fadeup" style="animation-delay:.05s">
    <div class="hist-stat">
      <div class="hist-stat__val"><?= count($orders) ?></div>
      <div class="hist-stat__lbl">Total Pesanan</div>
    </div>
    <div class="hist-stat">
      <div class="hist-stat__val"><?= count(array_filter($orders, fn($o) => $o['status']==='Selesai')) ?></div>
      <div class="hist-stat__lbl">Selesai</div>
    </div>
    <div class="hist-stat">
      <div class="hist-stat__val">Rp <?= number_format(array_sum(array_column(array_filter($orders, fn($o) => $o['status']==='Selesai'), 'total'))/1000, 0, ',', '.') ?>K</div>
      ...
      <div class="order-card__footer">
        ...
        <div class="order-actions">
          ...
          <?php if ($order['status'] === 'Selesai'): ?>
            <?php if (!$order['rating']): ?>
              <button class="btn-sm-outline"><i class="bi bi-star"></i> Beri Ulasan</button>
            <?php endif; ?>
            <a href="../cart/add-to-cart.php?id=<?= $order['items'][0]['image'] ?>"
               class="btn-sm-brand"><i class="bi bi-arrow-clockwise"></i> Pesan Lagi</a>
          <?php elseif ($order['status'] === 'Dibatalkan'): ?>
            <a href="../home/home.php" class="btn-sm-brand"><i class="bi bi-cup-hot"></i> Pesan Ulang</a>
          <?php else: ?>
            <button class="btn-sm-outline"><i class="bi bi-geo-alt"></i> Lacak</button>
          <?php endif; ?>
        </div>
      </div>
